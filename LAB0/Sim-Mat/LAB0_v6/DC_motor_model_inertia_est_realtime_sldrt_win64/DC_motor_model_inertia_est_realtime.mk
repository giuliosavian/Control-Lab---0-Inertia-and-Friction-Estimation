...
MODEL                := DC_motor_model_inertia_est_realtime
MODULES              := DC_motor_model_inertia_est_realtime_data.c DC_motor_model_inertia_est_realtime_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := DC_motor_model_inertia_est_realtime.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := DC_motor_model_inertia_est_realtime_ref.rsp
...
# additional includes
REQ_INCLUDES += ;Z:/windows_profile/Desktop/Lab_0/LAB_0/Mathlab_Simulink/LAB0_v5;Z:/windows_profile/Desktop/Lab_0/LAB_0/Mathlab_Simulink/LAB0_v5/DC_motor_model_inertia_est_realtime_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
