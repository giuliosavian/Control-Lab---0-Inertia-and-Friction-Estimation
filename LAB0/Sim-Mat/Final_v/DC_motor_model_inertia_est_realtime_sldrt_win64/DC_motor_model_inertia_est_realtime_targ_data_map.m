  ...
  ;%***********************
    ...
    ;%
    ;% Auto data (DC_motor_model_inertia_est_realtime_P)
    ;%
      section.nData     = 1;
      section.data(1)  = dumData; %prealloc
      
	  ;% DC_motor_model_inertia_est_realtime_P.ctrl
	  ...
	  ;% DC_motor_model_inertia_est_realtime_P.sens
	  ...
	  ;% DC_motor_model_inertia_est_realtime_P.drv
	  ...
	  ;% DC_motor_model_inertia_est_realtime_P.EncoderInput_MaxMissedTicks
	  section.data(6).logicalSrcIdx = 8;
	  section.data(6).dtTransOffset = 5;
	
	  ;% DC_motor_model_inertia_est_realtime_P.AnalogInput_MaxMissedTicks
	  section.data(7).logicalSrcIdx = 9;
	  section.data(7).dtTransOffset = 6;
	
	  ;% DC_motor_model_inertia_est_realtime_P.AnalogOutput_MaxMissedTicks
	  section.data(8).logicalSrcIdx = 10;
	  section.data(8).dtTransOffset = 7;
	
	  ;% DC_motor_model_inertia_est_realtime_P.RepeatingSequenceStair1_OutValues
	  section.data(9).logicalSrcIdx = 11;
	  section.data(9).dtTransOffset = 8;
	
	  ;% DC_motor_model_inertia_est_realtime_P.EncoderInput_YieldWhenWaiting
	  section.data(10).logicalSrcIdx = 12;
	  section.data(10).dtTransOffset = 10;
	
	  ;% DC_motor_model_inertia_est_realtime_P.AnalogInput_YieldWhenWaiting
	  section.data(11).logicalSrcIdx = 13;
	  section.data(11).dtTransOffset = 11;
	
	  ;% DC_motor_model_inertia_est_realtime_P.AnalogOutput_YieldWhenWaiting
	  ...
	  ;% DC_motor_model_inertia_est_realtime_P.TransferFcn1_A
	  section.data(1).logicalSrcIdx = 23;
	  section.data(1).dtTransOffset = 0;
	
	  ;% DC_motor_model_inertia_est_realtime_P.TransferFcn1_C
	  section.data(2).logicalSrcIdx = 24;
	  section.data(2).dtTransOffset = 2;
	
	  ;% DC_motor_model_inertia_est_realtime_P.TransferFcn_A
	  section.data(3).logicalSrcIdx = 25;
	  section.data(3).dtTransOffset = 4;
	
	  ;% DC_motor_model_inertia_est_realtime_P.TransferFcn_C
	  section.data(4).logicalSrcIdx = 26;
	  section.data(4).dtTransOffset = 6;
	
	  ;% DC_motor_model_inertia_est_realtime_P.TransferFcn2_A
	  section.data(5).logicalSrcIdx = 27;
	  section.data(5).dtTransOffset = 8;
	
	  ;% DC_motor_model_inertia_est_realtime_P.TransferFcn2_C
  ...
  ;%**************************
    ...
    ;%
    ;% Auto data (DC_motor_model_inertia_est_realtime_B)
    ;%
      section.nData     = 10;
	  ...
	  ;% DC_motor_model_inertia_est_realtime_B.Gain
  ...
  ;%*******************
    ...
    ;%
    ;% Auto data (DC_motor_model_inertia_est_realtime_DW)
    ;%
      section.nData     = 4;
      section.data(4)  = dumData; %prealloc
      
	  ;% DC_motor_model_inertia_est_realtime_DW._PWORK.LoggedData
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% DC_motor_model_inertia_est_realtime_DW.EncoderInput_PWORK
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 3;
	
	  ;% DC_motor_model_inertia_est_realtime_DW.AnalogInput_PWORK
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 4;
	
	  ;% DC_motor_model_inertia_est_realtime_DW.AnalogOutput_PWORK
	  section.data(4).logicalSrcIdx = 3;
  ...
  targMap.checksum0 = 3408010068;
  targMap.checksum1 = 3669854347;
  targMap.checksum2 = 1688201567;
  targMap.checksum3 = 3458747349;
